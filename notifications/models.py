...
class Notification(models.Model):
    ...
    redirect_url = models.URLField(max_length=500, null=True, unique=False, blank=True, help_text="Redirect Url when clicked")
    #msg to describe type of notification
